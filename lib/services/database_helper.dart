...
class DatabaseHelper {
  static final _dbName = 'todo_list.db';
  static final _dbVersion = 1;
  static final _tableName = 'myTable';

  static final columnTask = '_nameOfTask';
  static final taskStatus = '_iscompleted';
...
*/
  ...
  Future<int> delete(String taskName) async {
    Database db = await instance.database;
    return await db
        .delete(_tableName, where: '$columnTask = ?', whereArgs: [taskName]);
  }
}
